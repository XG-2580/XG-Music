      ...
      if(user) {
        ...
        interaction.reply({ephemeral: true, 
          embeds: [new MessageEmbed()
            ...
            .setFooter(`${user.username} | powered by imsathya.netlify.app`, "https://imgur.com/jPItIw0.gif")],
        ...
        interaction.reply({ephemeral: true, 
          embeds: [new MessageEmbed()
            ...
            .setFooter(`${client.user.username} | powered by imsathya.netlify.app`, "https://imgur.com/jPItIw0.gif")],
          components: allbuttons
        });
      }
    } catch (e) {
